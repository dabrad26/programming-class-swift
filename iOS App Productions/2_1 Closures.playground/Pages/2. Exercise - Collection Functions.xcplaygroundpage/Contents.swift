...
let friendsFamilies = ["Oliver", "Leo", "Will", "Marie", "Andrew", "Clancy", "Alexis"]

let sortedCollection1 = friendsFamilies.sorted(by: forwards)
...
let sortedCollection2 = friendsFamilies.sorted { (name1: String, name2: String) -> Bool in
    return name1 < name2
}
...
let sortedCollection3 = friendsFamilies.sorted { $0 < $1 }
